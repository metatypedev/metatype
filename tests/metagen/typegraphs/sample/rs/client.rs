...
impl_selection_traits!(Post1Selections, id, title, slug);
#[derive(Default, Debug)]
...
impl_selection_traits!(User2Selections, id, posts, email);
#[derive(Default, Debug)]
...
impl_selection_traits!(Post8Selections, title, slug, id);
#[derive(Default, Debug)]
