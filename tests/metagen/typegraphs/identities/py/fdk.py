...
class NodeDescs:
    ...
    def Primitives():
        return NodeMeta(
            sub_nodes={
                "str": NodeDescs.scalar,
                "enum": NodeDescs.scalar,
                "uuid": NodeDescs.scalar,
                "email": NodeDescs.scalar,
                "ean": NodeDescs.scalar,
                "json": NodeDescs.scalar,
                "uri": NodeDescs.scalar,
                "date": NodeDescs.scalar,
                "datetime": NodeDescs.scalar,
                "int": NodeDescs.scalar,
                "float": NodeDescs.scalar,
                "boolean": NodeDescs.scalar,
            },
        )
...
PrimitivesEnumStringEnum = typing.Union[
    typing.Literal["wan"],
    typing.Literal["tew"],
    typing.Literal["tree"],
]
...
PrimitivesEanStringEan = str

PrimitivesJsonStringJson = str

PrimitivesUriStringUri = str

PrimitivesDateStringDate = str

PrimitivesDatetimeStringDatetime = str

PrimitivesIntInteger = int

PrimitivesFloatFloat = float
...
class QueryGraph(QueryGraphBase):
    ...
    def py_proxy_primitives(self, args: typing.Union[PrimitivesArgs, PlaceholderArgs], select: PrimitivesSelections) -> QueryNode[Primitives]:
        node = selection_to_nodes(
    ...
    def ts_proxy_primitives(self, args: typing.Union[PrimitivesArgs, PlaceholderArgs], select: PrimitivesSelections) -> QueryNode[Primitives]:
        node = selection_to_nodes(
    ...
    def rs_proxy_primitives(self, args: typing.Union[PrimitivesArgs, PlaceholderArgs], select: PrimitivesSelections) -> QueryNode[Primitives]:
        node = selection_to_nodes(
...
def handler_proxy_primitives(user_fn: typing.Callable[[PrimitivesArgs, Ctx], Primitives]):
    def wrapper(raw_inp, gql_fn):
        qg = QueryGraph()
        host = Transports.hostcall(qg, gql_fn)
        cx = Ctx(gql_fn, qg, host)
