...
pub fn unlift_type_to_default_value(
    ...
    let ret = match ty {
        ...
        Type::Variant(variant_ty) => {
            ...
            let enum_ = component::Variant::new(variant_ty, first_case.name, first_payload)?;
            Val::Variant(enum_)
        }
...
pub fn wasmtime_val_to_value(value: &component::Val) -> anyhow::Result<serde_json::Value> {
    match value {
        ...
        // Val::Variant(value) => serde_json::to_string(value),

        // Val::Enum(value) => serde_json::to_string(value),
        _ => {
