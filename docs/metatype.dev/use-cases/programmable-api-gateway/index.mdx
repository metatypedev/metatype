...
<TGExample
  ...
  python={require("!!code-loader!../../../examples/typegraphs/programmable-api-gateway.py")}
  typescript={require("!!code-loader!../../../examples/typegraphs/programmable-api-gateway.ts")}
