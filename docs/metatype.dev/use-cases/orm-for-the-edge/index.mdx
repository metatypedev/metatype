...
Metatype can act out of the box as a lightweight relay API, simplifying database interactions via HTTP/GraphQL requests, and allowing you to query your database through the [Prisma runtime](/docs/reference/runtimes/prisma). Prisma is a well-known ORM library that provides a convenient interface to interact with PostgreSQL, MySQL, SQLite, SQL Server, MongoDB, CockroachDB databases.

<TGExample
  typegraph="prisma-runtime"
  python={require("!!code-loader!../../../../examples/typegraphs/prisma-runtime.py")}
  typescript={require("!!code-loader!../../../../examples/typegraphs/prisma-runtime.ts")}
