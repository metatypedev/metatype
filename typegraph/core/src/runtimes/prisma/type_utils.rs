...
use super::relationship::TargetAttributes;
...
// pub fn as_relationship_source(
//     id: TypeId,
// ) -> Result<Option<(RelationshipSource, TargetAttributes)>> {
//     with_store(|s| {
//         let attrs = s.get_attributes(id)?;
//
//         let target_attrs = TargetAttributes {
//             fkey: attrs
//                 .proxy_data
//                 .iter()
//                 .find_map(|(k, v)| (k == "fkey").then(|| v == "true")),
//             unique: attrs.is_unique_ref()?,
//         };
//
//         Ok(match s.get_type(attrs.concrete_type)? {
//             Type::Struct(s) => {
//                 Some(RelationshipSource {
//                     wrapper_type: id,
//                     model_type: attrs.concrete_type,
...
//                     Type::Struct(s) => Some(RelationshipSource {
//                         wrapper_type: id,
//                         model_type_name: s.base.name.clone().unwrap(), // TODO err
//                         model_type: inner,
