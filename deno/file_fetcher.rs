// Copyrighcratet 2018-2023 the Deno authors. All rights reserved. MIT license.
...
mod tests {
    ...
    async fn test_fetch_complex() {
        ...
        let cache_item_key = file_fetcher.http_cache.cache_item_key(&specifier).unwrap();
    ...
    fn create_test_client() -> HttpClient {
        HttpClient::from_client(
            create_http_client("test_client", CreateHttpClientOptions::default()).unwrap(),
        )
    }
            ...
            HttpClient::from_client(
                create_http_client(
                    ...
                    CreateHttpClientOptions {
                        ca_certs: vec![
                            read(test_util::testdata_path().join("tls/RootCA.pem")).unwrap()
                        ],
                        ..Default::default()
                    },
                )
    ...
    #[track_caller]
    fn get_text_from_cache(file_fetcher: &FileFetcher, url: &ModuleSpecifier) -> String {
