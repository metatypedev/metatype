...
Typegraphs allow you to specify granular access control when exposing your materializers. This can be done at the materializer or the type field level. This section also makes use of toy typegraph for the sake of clarity.
