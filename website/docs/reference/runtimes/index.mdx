...
## Tiers
In total, metatype aims to supports 3 types of runtimes, each type corresponding to a tier.
...
This includes any runtime that is already embedded within typegate that performs specialized tasks.
