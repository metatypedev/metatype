...
In some cases, as your typegraph gets more complicated, you may want to automate the step of generating clients and focus on the actual logic of your application instead.

The OpenAPI spec will be available at `{TYPEGATE_URL}/{TG_NAME}/rest/__schema`, which is very useful considering that there is already exist
a handful amount of tools that enables you creating clients from an existing OpenAPI specification file.

Once you download the specification file for your API, it should look like something like this:
```javascript
// my_awesome_typegraph_openapi.json
{
  "openapi": "3.0.3",
  "info": {
  ...
  "paths": { 
    // typing each path manually can be very tedious as your API grows
...
* Multilang: https://github.com/OpenAPITools/openapi-generator
* Multilang: https://www.npmjs.com/package/@openapitools/openapi-generator-cli

* Flutter: https://pub.dev/packages/openapi_generator
...
which is basically a wrapper around [openapi-generator](https://github.com/OpenAPITools/openapi-generator) and will download the appropriate dependencies for you.
...
In this example, let's generate a simple fetch clientm, you can refer to their official documentation for other generators.
