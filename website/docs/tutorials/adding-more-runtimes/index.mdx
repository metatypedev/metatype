...
[Prisma](https://www.prisma.io/) is a "Next-generation Node.js and Typescript ORM" that support for PostgreSQL, MySQL/MariaDB, SQLite, MongoDB, CockroachDB and Microsoft SQL Server. It is one of the main runtimes provided by Metatype and doesn't require any additional installation.
