...
Alternatively, you can use the typegraph_std package for the most common APIs.

It currently includes:
- Google API (fcm, firebase, youtube, etc.)
- Stripe
- Github

They work pretty much the same way as Importers.
