...
You will design some APIs for a chat-based app where users can exchange messages.
...
```bash
softwareupdate --install-rosetta # if you're on an Apple Silicon
brew install docker
```
...
<details>
  <summary>Alternative installation from source</summary>
