    ...
    [
      {
        ...
        body: (
          <>
            ...
            These root-functions will serve as the entry point to your graph
    ...
    [
      {
        ...
        body: (
          <>
            ...
            configured granularly for each function and for custom time
  ...
  rows={[
      ...
      },
      {
        ...
        body: (
          <>
            ...
            functions or provide defaults for incoming request data. This
    ...
    [
      ...
      },
      {
        ...
        body: (
          <>
            Compose functions together by feeding the output of one as the
            input of another. Encourages code reuse by allowing one to extract
            common middleware logic from each function, all within the
            typegraph layer.
          </>
        ),
      },
    ...
    [
      {
        ...
        body: (
          <>
            <code>reduce</code> is useful to transform function input types
      ...
      },
      {
        ...
        body: (
          <>
            <code>apply</code> allows the flattening of deeply nested
            function input types to something friendlier. Injection can also
  ...
  rows={[
    ...
    [
      ...
      },
      {
        ...
        body: (
          <>
            Easily generate functions for common create, update, read and
