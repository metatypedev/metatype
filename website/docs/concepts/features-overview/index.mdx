      ...
      }, 
      {
        ...
        body: (
          <>
           ...
           Inputs will be sourced from either http bodies or search paremters according to HTTP verb.
          </>
        ),
      }, 
    ],
      ...
      }, 
      {
        ...
        body: (
          <>
            ...
            Prevents abuse from websites trying to use your API without permisison.
          </>
        ),
      }, 
    ],
    [
      {
        ...
        body: (
          <>
            The typegate can be run as a single node mode for simple deployments and using the filesystem as it's artifact store. 
      ...
      }, 
      {
        ...
        body: (
          <>
            ...
            Useful to validate incoming data even more and distrubute invariants through your app.
          </>
        ),
      }, 
    ],
      ...
      }, 
      {
        ...
        body: (
          <>
            ...
            Encourages code reuse by allowing one to extract common middleware logic from each materializers all within the typegraph layer.
          </>
        ),
      }, 
    ],
      ...
      }, 
      {
        ...
        body: (
          <>
            ...
            Temporal is durable execution engine that can be used to implement long-running, failure-resistant business processes.
          </>
        ),
      }, 
      {
    ...
    [
      {
        ...
        body: (
          <>
            ...
            This means support forrimary keys, unique constraints, one-to-one, one-to-many, many-to-many relationships...etc.
          </>
        ),
      }, 
      {
      ...
      }, 
      {
        ...
        body: (
          <>
            ...
            Useful to access unique features native to your database or craft extra efficent queries.
          </>
        ),
      }, 
    ],
    ...
    [
      {
        ...
        body: (
          <>
            Policies are simple functions that take the request as input and return values to signal whether or not it's allowed/denied access.
    ...
    [
      {
        ...
        body: (
          <>
            ...
            Bundles the typegate within it making the CLI all one needs to get started. (And a text editor ofcourse.)
          </>
        ),
      }, 
    ],
    ...
    [
      {
        ...
        body: (
          <>
            Programmaticaly upload your typegraphs to the typegate from within the SDK.
    ...
    [
      {
        ...
        body: (
          <>
            Access metagen through the SDK directly to generate type declaration and other helpful code.
