...
- [**Meta**](meta): a command-line tool for smooth developer experience (DX) and deployment
...
As a project/product/start-up evolves, the technological stack becomes a challenging place where initiatives collides and efficiency struggles. Especially:
...
Taking the analogy of a Postgres database, this is similar to SQL data definition language (DDL) and is not limited to tabular data.
