...
:::info Why Python?
Python is a high-level general purpose language with great readability and dynamic typing. This was an asset during the prototyping phase to quickly iterate on the design. It has now fewer benefits but remains an abordable language for everyone to pick up. None of the core features are tied to advanced features of the language.
