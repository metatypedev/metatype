...
- [OAuth2](/docs/reference/typegate/authentication#oauth2-authentication)
...
An empty object.
Authentication is only responsible for populating the context object and without a policy to shoot down the reqest, it'll access the materalizers.
