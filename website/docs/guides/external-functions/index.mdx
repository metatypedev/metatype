...
## Typegraph
<CodeBlock language="python">{require("../../../typegraphs/math.py").content}</CodeBlock>

## External function definition
<!-- <CodeBlock language="typescript">{require("../../../typegraphs/scripts/fib.ts").content}</CodeBlock> -->
