...
Microservices and miniservices are architectural styles for developing applications by breaking them down into small, independent services that can be deployed and scaled independently. Each micro or mini service typically focuses on a specific business function or task, and communicates with other services through well-defined APIs.
...
<TGExample
  typegraph="team-a"
  python={require("!!code-loader!../../../examples/typegraphs/microservice-orchestration.py")}
  typescript={require("!!code-loader!../../../examples/typegraphs/microservice-orchestration.ts")}
