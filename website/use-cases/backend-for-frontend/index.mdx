...
Imagine you have a web frontend and a mobile app that both consume data from a microservices-based backend. The web frontend requires certain data fields in a format B, and the mobile app requires the same field plus additional ones in format B.
