...
It's the place where you tell what typegate you want to deploy to, how you would want to the artifacts to be resolved and others.
...
Now, picture this, you have a lot of typegraphs and one or more typegate instance(s) running, you can easily make a small scripts that does any specific job you want.
...
export function getConfig(tgName: string, tgLocation: string) {
  // Note: You can always develop various ways of constructing the configuration file,
...
With these new additions, you can automate pretty much anything programmatically.
