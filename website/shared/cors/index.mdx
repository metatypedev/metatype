...
Cross-Origin Resource Sharing (CORS) is a mechanism that allows or denies cross-origin requests in the browser.
...
More details can be found [here](https://developer.mozilla.org/en/docs/Web/HTTP/CORS).
...
<TGExample
  typegraph="cors"
  python={require("../../../examples/typegraphs/cors.py")}
  query={require("./cors.graphql")}
/>
