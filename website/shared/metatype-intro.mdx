Metatype is an open platform for developers to **declaratively build APIs**. It offers a new approach to building backends, where developers focus on data modelling and delegate the implementation to the platform.
