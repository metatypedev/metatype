...
There are two runtimes defined namely [PythonRuntime](/docs/reference/runtimes/python) and [DenoRuntime](/docs/reference/runtimes/deno). We will be using these two runtimes to perform different data operations along with the other [runtimes](/docs/referenece/runtimes) Metatype provides. 
```typescript
