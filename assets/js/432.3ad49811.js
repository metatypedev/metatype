...
/* harmony import */ var _show_hint_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63940);
/* harmony import */ var graphql_language_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32391);
/* harmony import */ var _codemirror_es2_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(40027);




_codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.registerHelper("hint", "graphql", (n, c) => {
  const { schema: i, externalFragments: p, autocompleteOptions: u } = c;
  if (!i)
    return;
  const s = n.getCursor(), o = n.getTokenAt(s), a = o.type !== null && /"|\w/.test(o.string[0]) ? o.start : o.end, g = new graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .Position */ .yX(s.line, a), t = {
    list: (0,graphql_language_service__WEBPACK_IMPORTED_MODULE_2__/* .getAutocompleteSuggestions */ .CE)(i, n.getValue(), g, o, p, u).map((e) => {
      var l;
      return {
  ...
  return t != null && t.list && t.list.length > 0 && (t.from = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(t.from.line, t.from.ch), t.to = _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.Pos(t.to.line, t.to.ch), _codemirror_es_js__WEBPACK_IMPORTED_MODULE_0__.C.signal(n, "hasCompletion", n, t, o)), t;
});
