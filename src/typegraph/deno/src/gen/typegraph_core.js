  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      ...
      for (let i = 0; i < len22; i++) {
        ...
        var result21 = utf8Decoder.decode(
          new Uint8Array(memory0.buffer, ptr21, len21),
        );
...
function serializeTypegraph(arg0) {
  var {
    typegraphPath: v0_0,
    prefix: v0_1,
    artifactResolution: v0_2,
    codegen: v0_3,
    prismaMigration: v0_4,
    pretty: v0_5,
  } = arg0;
  ...
  var {
    migrationsDir: v4_0,
    migrationActions: v4_1,
    defaultMigrationAction: v4_2,
  } = v0_4;
  ...
  for (let i = 0; i < vec9.length; i++) {
    const e = vec9[i];
    const base = result9 + i * 12;
    var [tuple6_0, tuple6_1] = e;
  ...
  const ret = exports1["metatype:typegraph/core#serialize-typegraph"](
    ptr1,
    len1,
    variant3_0,
    variant3_1,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      var result11 = utf8Decoder.decode(
    ...
    case 1: {
      ...
      for (let i = 0; i < len16; i++) {
        ...
        var result15 = utf8Decoder.decode(
          new Uint8Array(memory0.buffer, ptr15, len15),
        );
...
function refb(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/core#refb"](
    ptr0,
    len0,
    result4,
    len4,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      ...
      for (let i = 0; i < len18; i++) {
        ...
        var result17 = utf8Decoder.decode(
...
function stringb(arg0, arg1) {
  var ptr0 = realloc0(0, 0, 4, 80);
  var { min: v1_0, max: v1_1, format: v1_2, pattern: v1_3, enumeration: v1_4 } =
    arg0;
  var variant2 = v1_0;
  if (variant2 === null || variant2 === undefined) {
    dataView(memory0).setInt8(ptr0 + 0, 0, true);
...
function fileb(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/core#fileb"](
    variant1_0,
    variant1_1,
    variant2_0,
    variant2_1,
...
function listb(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/core#listb"](
    toUint32(v0_0),
    variant1_0,
    variant1_1,
    variant2_0,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      ...
      for (let i = 0; i < len19; i++) {
        ...
        var result18 = utf8Decoder.decode(
          new Uint8Array(memory0.buffer, ptr18, len18),
        );
...
function extendStruct(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/core#extend-struct"](
    toUint32(arg0),
    result2,
    len2,
  );
...
function getTransformData(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/core#get-transform-data"](
    toUint32(arg0),
    ptr0,
    len0,
  );
    ...
    switch (variant5.tag) {
      ...
      default: {
        throw new TypeError(
          ...
          }\` (received \`${variant5}\`) specified for \`PolicySpec\``,
        );
      }
    }
  }
...
function registerContextPolicy(arg0, arg1) {
  ...
  switch (variant3.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant3.tag)
        }\` (received \`${variant3}\`) specified for \`ContextCheck\``,
      );
    }
  }
...
function renameType(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/core#rename-type"](
    toUint32(arg0),
    ptr0,
    len0,
  );
    ...
    for (let i = 0; i < vec9.length; i++) {
      ...
      switch (variant8.tag) {
        ...
        default: {
          throw new TypeError(
            `invalid variant tag value \`${
              JSON.stringify(variant8.tag)
            }\` (received \`${variant8}\`) specified for \`PolicySpec\``,
          );
        }
      }
    }
...
function setSeed(arg0) {
  ...
  const ret = exports1["metatype:typegraph/core#set-seed"](
    variant0_0,
    variant0_1,
  );
  let variant3;
  ...
  switch (variant4.tag) {
    ...
    default: {
      throw new TypeError(
        ...
        }\` (received \`${variant4}\`) specified for \`Effect\``,
      );
    }
  }
...
function registerDenoStatic(arg0, arg1) {
  ...
  var ptr1 = utf8Encode(v0_0, realloc0, memory0);
  var len1 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/runtimes#register-deno-static"](
    ptr1,
    len1,
    toUint32(arg1),
  );
...
function importDenoFunction(arg0, arg1) {
  ...
  switch (variant7.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant7.tag)
        }\` (received \`${variant7}\`) specified for \`Effect\``,
      );
    }
  }
...
function graphqlQuery(arg0, arg1) {
  ...
  switch (variant1.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant1.tag)
        }\` (received \`${variant1}\`) specified for \`Effect\``,
      );
    }
  }
  var { path: v2_0 } = arg1;
...
function httpRequest(arg0, arg1) {
  ...
  switch (variant2.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant2.tag)
        }\` (received \`${variant2}\`) specified for \`Effect\``,
      );
    }
  }
  var {
...
function registerWasmReflectedRuntime(arg0) {
  ...
  var len1 = utf8EncodedLen;
  const ret = exports1
    ["metatype:typegraph/runtimes#register-wasm-reflected-runtime"](ptr1, len1);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant4 = {
...
function fromWasmReflectedFunc(arg0, arg1) {
  ...
  var len3 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/runtimes#from-wasm-reflected-func"](
    toUint32(v0_0),
    variant1_0,
    variant1_1,
    ptr3,
...
function registerWasmWireRuntime(arg0) {
  ...
  var len1 = utf8EncodedLen;
  const ret = exports1
    ["metatype:typegraph/runtimes#register-wasm-wire-runtime"](ptr1, len1);
  let variant4;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant4 = {
...
function fromWasmWireHandler(arg0, arg1) {
  ...
  var ptr3 = utf8Encode(v2_0, realloc0, memory0);
  var len3 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/runtimes#from-wasm-wire-handler"](
    toUint32(v0_0),
    variant1_0,
    variant1_1,
    ptr3,
...
function prismaExecute(arg0, arg1, arg2, arg3) {
  ...
  const ret = exports1["metatype:typegraph/runtimes#prisma-execute"](
    toUint32(arg0),
    ptr0,
    len0,
    toUint32(arg2),
...
function prismaQueryRaw(arg0, arg1, arg2, arg3) {
  ...
  const ret = exports1["metatype:typegraph/runtimes#prisma-query-raw"](
    toUint32(arg0),
    ptr0,
    len0,
    variant1_0,
...
function prismaMigration(arg0) {
  ...
  switch (val0) {
    ...
    default: {
      ...
      throw new TypeError(
        `"${val0}" is not one of the cases of prisma-migration-operation`,
      );
    }
  }
  ...
  switch (variant5.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant5.tag)
        }\` (received \`${variant5}\`) specified for \`TemporalOperationType\``,
      );
    }
  }
  const ret = exports1
...
function registerTypegateMaterializer(arg0) {
  ...
  switch (val0) {
    ...
    default: {
      ...
      throw new TypeError(
        `"${val0}" is not one of the cases of typegate-operation`,
      );
    }
  }
  const ret = exports1
    ["metatype:typegraph/runtimes#register-typegate-materializer"](enum0);
  let variant3;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant3 = {
...
function registerTypegraphMaterializer(arg0) {
  ...
  switch (val0) {
    ...
    default: {
      ...
      throw new TypeError(
        `"${val0}" is not one of the cases of typegraph-operation`,
      );
    }
  }
  const ret = exports1
    ["metatype:typegraph/runtimes#register-typegraph-materializer"](enum0);
  let variant3;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      variant3 = {
...
function registerSubstantialRuntime(arg0) {
  var { endpoint: v0_0, basicAuthSecret: v0_1 } = arg0;
  var ptr1 = utf8Encode(v0_0, realloc0, memory0);
  var len1 = utf8EncodedLen;
  var variant3 = v0_1;
  let variant3_0;
  ...
  const ret = exports1
    ["metatype:typegraph/runtimes#register-substantial-runtime"](
      ptr1,
      len1,
      variant3_0,
      variant3_1,
...
function generateSubstantialOperation(arg0, arg1) {
  var { funcArg: v0_0, operation: v0_1 } = arg1;
  var variant1 = v0_0;
  let variant1_0;
  let variant1_1;
  if (variant1 === null || variant1 === undefined) {
  ...
  switch (variant20.tag) {
    case "start": {
      ...
      var { name: v2_0, file: v2_1, deps: v2_2, kind: v2_3 } = e;
      var ptr3 = utf8Encode(v2_0, realloc0, memory0);
      var len3 = utf8EncodedLen;
      ...
      switch (val7) {
        ...
        default: {
          if (v2_3 instanceof Error) {
            console.error(v2_3);
          }

          throw new TypeError(
            `"${val7}" is not one of the cases of workflow-kind`,
          );
        }
      }
      variant20_0 = 0;
    ...
    case "stop": {
      const e = variant20.val;
      var { name: v8_0, file: v8_1, deps: v8_2, kind: v8_3 } = e;
      ...
      var vec12 = v8_2;
      var len12 = vec12.length;
      var result12 = realloc0(0, 0, 4, len12 * 8);
      for (let i = 0; i < vec12.length; i++) {
        const e = vec12[i];
        const base = result12 + i * 8;
        var ptr11 = utf8Encode(e, realloc0, memory0);
        var len11 = utf8EncodedLen;
      ...
      switch (val13) {
        ...
        default: {
          if (v8_3 instanceof Error) {
            console.error(v8_3);
          }

          throw new TypeError(
            `"${val13}" is not one of the cases of workflow-kind`,
          );
        }
      }
      variant20_0 = 1;
    ...
    case "send": {
      const e = variant20.val;
      var { name: v14_0, file: v14_1, deps: v14_2, kind: v14_3 } = e;
      ...
      switch (val19) {
        ...
        default: {
          if (v14_3 instanceof Error) {
            console.error(v14_3);
          }

          throw new TypeError(
            `"${val19}" is not one of the cases of workflow-kind`,
          );
        }
      }
      variant20_0 = 2;
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant20.tag)
        }\` (received \`${variant20}\`) specified for \`SubstantialOperationType\``,
      );
    }
  }
  const ret = exports1
    ["metatype:typegraph/runtimes#generate-substantial-operation"](
      toUint32(arg0),
      variant1_0,
      variant1_1,
      variant20_0,
...
function registerKvRuntime(arg0) {
  var { url: v0_0 } = arg0;
  var ptr1 = utf8Encode(v0_0, realloc0, memory0);
  var len1 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/runtimes#register-kv-runtime"](
    ptr1,
    len1,
  );
  let variant4;
...
function kvOperation(arg0, arg1) {
  var { runtime: v0_0, effect: v0_1 } = arg0;
  var variant1 = v0_1;
  let variant1_0;
  let variant1_1;
  ...
  switch (val2) {
    ...
    default: {
      ...
      throw new TypeError(
        `"${val2}" is not one of the cases of kv-materializer`,
      );
    }
  }
  const ret = exports1["metatype:typegraph/runtimes#kv-operation"](
    toUint32(v0_0),
    variant1_0,
    variant1_1,
    enum2,
...
function genReduceb(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/utils#gen-reduceb"](
    toUint32(arg0),
    result7,
    len7,
  );
...
function addGraphqlEndpoint(arg0) {
  var ptr0 = utf8Encode(arg0, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#add-graphql-endpoint"](
    ptr0,
    len0,
  );
  let variant3;
...
function addAuth(arg0) {
  ...
  switch (variant2.tag) {
    ...
    default: {
      throw new TypeError(
        `invalid variant tag value \`${
          JSON.stringify(variant2.tag)
        }\` (received \`${variant2}\`) specified for \`AuthProtocol\``,
      );
    }
  }
  var vec6 = v0_2;
  ...
  const ret = exports1["metatype:typegraph/utils#add-auth"](
    ptr1,
    len1,
    variant2_0,
    result6,
...
function oauth2(arg0, arg1) {
  ...
  var len1 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#oauth2"](
    ptr0,
    len0,
    ptr1,
    len1,
...
function oauth2WithoutProfiler(arg0, arg1) {
  ...
  var ptr1 = utf8Encode(arg1, realloc0, memory0);
  var len1 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#oauth2-without-profiler"](
    ptr0,
    len0,
    ptr1,
    len1,
...
function oauth2WithExtendedProfiler(arg0, arg1, arg2) {
  ...
  var len2 = utf8EncodedLen;
  const ret = exports1
    ["metatype:typegraph/utils#oauth2-with-extended-profiler"](
      ptr0,
      len0,
      ptr1,
      len1,
...
function oauth2WithCustomProfiler(arg0, arg1, arg2) {
  ...
  var ptr1 = utf8Encode(arg1, realloc0, memory0);
  var len1 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#oauth2-with-custom-profiler"](
    ptr0,
    len0,
    ptr1,
    len1,
...
function gqlDeployQuery(arg0) {
  ...
  const ret = exports1["metatype:typegraph/utils#gql-deploy-query"](
    ptr1,
    len1,
    variant6_0,
    variant6_1,
...
function gqlRemoveQuery(arg0) {
  ...
  const ret = exports1["metatype:typegraph/utils#gql-remove-query"](
    result1,
    len1,
  );
  let variant5;
...
function removeInjections(arg0) {
  const ret = exports1["metatype:typegraph/utils#remove-injections"](
    toUint32(arg0),
  );
  let variant2;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
...
function metagenExec(arg0) {
  ...
  var len4 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#metagen-exec"](
    ptr1,
    len1,
    ptr2,
    len2,
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      ...
      var len9 = dataView(memory0).getInt32(ret + 8, true);
      var result9 = utf8Decoder.decode(
        new Uint8Array(memory0.buffer, ptr9, len9),
      );
      variant10 = {
        tag: "err",
        val: result9,
...
function metagenWriteFiles(arg0, arg1) {
  ...
  for (let i = 0; i < vec3.length; i++) {
    const e = vec3[i];
    const base = result3 + i * 20;
    var { path: v0_0, content: v0_1, overwrite: v0_2 } = e;
    var ptr1 = utf8Encode(v0_0, realloc0, memory0);
    var len1 = utf8EncodedLen;
    dataView(memory0).setInt32(base + 4, len1, true);
    dataView(memory0).setInt32(base + 0, ptr1, true);
  ...
  var len4 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/utils#metagen-write-files"](
    result3,
    len3,
    ptr4,
    len4,
...
function registerS3Runtime(arg0) {
  var {
    hostSecret: v0_0,
    regionSecret: v0_1,
    accessKeySecret: v0_2,
    secretKeySecret: v0_3,
    pathStyleSecret: v0_4,
  } = arg0;
  var ptr1 = utf8Encode(v0_0, realloc0, memory0);
  var len1 = utf8EncodedLen;
  var ptr2 = utf8Encode(v0_1, realloc0, memory0);
  ...
  var len5 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/aws#register-s3-runtime"](
    ptr1,
    len1,
    ptr2,
    len2,
...
function s3PresignGet(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/aws#s3-presign-get"](
    toUint32(arg0),
    ptr1,
    len1,
    variant2_0,
...
function s3PresignPut(arg0, arg1) {
  ...
  const ret = exports1["metatype:typegraph/aws#s3-presign-put"](
    toUint32(arg0),
    ptr1,
    len1,
    variant2_0,
...
function s3List(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/aws#s3-list"](
    toUint32(arg0),
    ptr0,
    len0,
  );
...
function s3Upload(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/aws#s3-upload"](
    toUint32(arg0),
    ptr0,
    len0,
  );
...
function s3UploadAll(arg0, arg1) {
  var ptr0 = utf8Encode(arg1, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = exports1["metatype:typegraph/aws#s3-upload-all"](
    toUint32(arg0),
    ptr0,
    len0,
  );
...
const $init = (() => {
  let gen = (function* init() {
    ...
    const module1 = base64Compile(
      "",
    );
    const module2 = base64Compile(
      "AGFzbQEAAAABFANgAn9/AGAFf39/f38AYAN/f38AAikGAAEwAAAAATEAAQABMgACAAEzAAIAATQAAQAIJGltcG9ydHMBcAEFBQkLAQBBAAsFAAECAwQALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjIwOC4xABwEbmFtZQAVFHdpdC1jb21wb25lbnQ6Zml4dXBz",
    );
    ...
    postReturn0 =
      exports1["cabi_post_metatype:typegraph/aws#register-s3-runtime"];
    postReturn1 =
      exports1["cabi_post_metatype:typegraph/core#serialize-typegraph"];
    postReturn2 = exports1["cabi_post_metatype:typegraph/core#get-type-repr"];
    postReturn3 =
      exports1["cabi_post_metatype:typegraph/core#get-transform-data"];
    postReturn4 =
      exports1["cabi_post_metatype:typegraph/core#get-internal-policy"];
    postReturn5 = exports1["cabi_post_metatype:typegraph/utils#metagen-exec"];
    postReturn6 =
      exports1["cabi_post_metatype:typegraph/utils#metagen-write-files"];
  })();
...
const runtimes = {
  ...
  generateSubstantialOperation: generateSubstantialOperation,
  ...
  registerKvRuntime: registerKvRuntime,
  ...
  registerSubstantialRuntime: registerSubstantialRuntime,
...
export { aws, core, runtimes, utils };
