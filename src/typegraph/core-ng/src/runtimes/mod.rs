...
use crate::types::aws::S3RuntimeData;
use crate::types::core::{FuncParams, MaterializerId, RuntimeId, TypeId as CoreTypeId};
use crate::types::runtimes::{
    BaseMaterializer, Effect, GraphqlRuntimeData, GrpcData, GrpcRuntimeData, HttpRuntimeData,
...
//             WitOp::ListTypegraphs => (Effect::Read, Op::ListTypegraphs),
//             WitOp::FindTypegraph => (Effect::Read, Op::FindTypegraph),
//             WitOp::AddTypegraph => (Effect::Create(true), Op::AddTypegraph),
//             WitOp::RemoveTypegraphs => (Effect::Delete(true), Op::RemoveTypegraphs),
//             WitOp::GetSerializedTypegraph => (Effect::Read, Op::GetSerializedTypegraph),
//             WitOp::GetArgInfoByPath => (Effect::Read, Op::GetArgInfoByPath),
//             WitOp::FindAvailableOperations => (Effect::Read, Op::FindAvailableOperations),
//             WitOp::FindPrismaModels => (Effect::Read, Op::FindPrismaModels),
//             WitOp::RawPrismaRead => (Effect::Read, Op::RawPrismaQuery),
//             WitOp::RawPrismaCreate => (Effect::Create(false), Op::RawPrismaQuery),
//             WitOp::RawPrismaUpdate => (Effect::Update(false), Op::RawPrismaQuery),
//             WitOp::RawPrismaDelete => (Effect::Delete(true), Op::RawPrismaQuery),
//             WitOp::QueryPrismaModel => (Effect::Read, Op::QueryPrismaModel),
//         };
//
...
//
//         let (effect, op) = match operation {
//             WitOp::Resolver => (Effect::Read, Op::Resolver),
//             WitOp::GetType => (Effect::Read, Op::GetType),
//             WitOp::GetSchema => (Effect::Read, Op::GetSchema),
//         };
//
