...
// @@protoc_insertion_point(message:substantial.protos.events.Log)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Log {
    // message fields
    // @@protoc_insertion_point(field:substantial.protos.events.Log.id)
    pub id: u32,
    // @@protoc_insertion_point(field:substantial.protos.events.Log.json_payload)
    pub json_payload: ::std::string::String,
    // @@protoc_insertion_point(field:substantial.protos.events.Log.level)
    pub level: u32,
    // special fields
    // @@protoc_insertion_point(special_field:substantial.protos.events.Log.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl Log {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "json_payload",
            |m: &Log| { &m.json_payload },
            |m: &mut Log| { &mut m.json_payload },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "level",
            |m: &Log| { &m.level },
...
impl Event {
    ...
    // .substantial.protos.events.Log log = 15;

    pub fn log(&self) -> &Log {
        match self.of {
            ::std::option::Option::Some(event::Of::Log(ref v)) => v,
            _ => <Log as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn has_log(&self) -> bool {
        match self.of {
            ::std::option::Option::Some(event::Of::Log(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_log(&mut self, v: Log) {
        self.of = ::std::option::Option::Some(event::Of::Log(v))
    }

    // Mutable pointer to the field.
    pub fn mut_log(&mut self) -> &mut Log {
        if let ::std::option::Option::Some(event::Of::Log(_)) = self.of {
        } else {
            self.of = ::std::option::Option::Some(event::Of::Log(Log::new()));
        }
        match self.of {
            ::std::option::Option::Some(event::Of::Log(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_log(&mut self) -> Log {
        if self.has_log() {
            match self.of.take() {
                ::std::option::Option::Some(event::Of::Log(v)) => v,
                _ => panic!(),
            }
        } else {
            Log::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, Log>(
            "log",
            Event::has_log,
            Event::log,
            Event::mut_log,
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                122 => {
                    self.of = ::std::option::Option::Some(event::Of::Log(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
pub mod event {
    ...
    pub enum Of {
        ...
        Stop(super::Stop),
        // @@protoc_insertion_point(oneof_field:substantial.protos.events.Event.log)
        Log(super::Log),
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0cjson_payload\x18\x02\x20\x01(\tR\x0bjsonPayload\x12\x14\n\x05level\
    \x18\x03\x20\x01(\rR\x05level\"w\n\x05Sleep\x12\x0e\n\x02id\x18\x01\x20\
    ...
    \x0b2\x1f.substantial.protos.events.StopH\0R\x04stop\x122\n\x03log\x18\
    \x0f\x20\x01(\x0b2\x1e.substantial.protos.events.LogH\0R\x03logB\x04\n\
    \x02of\"Z\n\x07Records\x12\x15\n\x06run_id\x18\x01\x20\x01(\tR\x05runId\
    \x128\n\x06events\x18\x02\x20\x03(\x0b2\x20.substantial.protos.events.Ev\
    entR\x06eventsJ\xa0\x0f\n\x06\x12\x04\0\0H\x01\n\x08\n\x01\x0c\x12\x03\0\
    ...
    \x04\x05\x02\x01\x12\x03#\x02\x1a\n\x0c\n\x05\x04\x05\x02\x01\x05\x12\
    \x03#\x02\x08\n\x0c\n\x05\x04\x05\x02\x01\x01\x12\x03#\t\x15\n\x0c\n\x05\
